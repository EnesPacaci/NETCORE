...
namespace Enes_Api.Repositories.StatisticsRepositories
{
    public class StatisticsRepository : IStatisticsRepository
    {
        ...
        {
            string query = "Select Name,Count(*) 'product_count' From Product Inner Joın Employee On Product.EmployeeID=Employee.EmployeeID Group By Name Order By product_count Desc";
            using (var connection = _context.CreaConnection())
            {
                var values = connection.QueryFirstOrDefault<string>(query);
                return values;
        ...
        public decimal LastPriceProduct()
        {
